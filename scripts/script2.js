...
function Dinheiro(){}
Dinheiro.prototype.nome = '';
Dinheiro.prototype.sigla = '';
Dinheiro.prototype.pais = '';
Dinheiro.prototype.continente = '';
Dinheiro.prototype.filtrar = function (item) { return item => item.local == loc;}

class Dinheiro {
    constructor(nome, sigla, pais, continente){
        this.nome = nome; 
        this.sigla = sigla;
        this.pais = pais;
    ...
    filtrar(item){
        return  item => item.local == loc;
    }
}

const rublo =  new Dinheiro ("rublo", "₽", "Rússia" , "Europa");
console.log(rublo)